...
function OrbitItem({ item, index, totalItems, path, itemWidth, itemHeight, rotation, progress, fill }: any) {
...
export default function OrbitImages({
  ...
  const items = images.map((src, index) => (
    <div
      key={src}
      className="relative w-full h-full rounded-[20px] overflow-hidden group cursor-pointer transition-transform duration-300 hover:scale-[1.15] shadow-lg hover:shadow-[0_0_30px_rgba(192,132,252,0.4)] bg-[#0a0a0a]"
    ...
    >
      ...
      {/* Border overlay */}
      <div className="absolute inset-0 rounded-[20px] border border-white/10 group-hover:border-purple-400 transition-colors duration-300 pointer-events-none" />
    </div>
  ));
          ...
          {selectedImage && (
            ...
            >
              <motion.div
                ...
                className="relative max-w-5xl w-full max-h-[90vh] aspect-[16/9] md:aspect-auto md:h-[80vh] rounded-3xl overflow-hidden border border-purple-500/30 shadow-[0_0_50px_rgba(168,85,247,0.2)] bg-[#050505] flex items-center justify-center"
